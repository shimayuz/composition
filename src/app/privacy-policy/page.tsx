...
// マークダウンコンテンツを直接埋め込む（Edge Runtimeと互換性のある方法）
const markdownContent = `# プライバシーポリシー

合同会社コンポジション（以下、「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下、「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
...
住所：〒155-0032 東京都世田谷区代沢5-19-12 2F
社名：合同会社コンポジション
担当部署：お客様サポート
電話番号：090-1695-6422
Eメールアドレス：info@composition2940.com`;
