      ...
      <div className="prose max-w-3xl mx-auto mt-8">
          <table className="min-w-full border-collapse border border-gray-300 mb-8">
            <tbody>
              ...
              <tr className="border-b border-gray-300">
                <th className="py-3 px-4 text-left bg-gray-100">決済期間</th>
                <td className="py-3 px-4">
                  クレジットカード決済の場合はご注文時に即時決済されます。その他の決済方法の場合は、各決済方法の指示に従ってください。
                </td>
              </tr>
              <tr className="border-b border-gray-300">
              ...
              <tr className="border-b border-gray-300">
                <th className="py-3 px-4 text-left bg-gray-100">返品・交換・返金について</th>
                <td className="py-3 px-4">
                  <p><strong>＜お客様都合による返金・交換の場合＞</strong><br />
                  本サービス購入後の返金対応はいたしかねますので予めご了承ください。販売する本サービスについて、当社の定める方法で返金可能とするかを選択するものとします。返金可能とされたサービスについては、ユーザーが購入してから48時間以内に返金の意思表示をし、かつ当社が認めた場合には、ユーザーと当社の購入契約が解除されます。</p>
                  
                  <p><strong>＜サービスに不備がある場合＞</strong><br />
                  サービスに当社の責による重大な不備があり、サービスの主要な機能が利用できない場合は、お問い合わせフォームよりご連絡ください。状況を確認の上、適切な対応（返金または代替サービスの提供など）をさせていただきます。</p>
                </td>
              </tr>
              <tr className="border-b border-gray-300">
