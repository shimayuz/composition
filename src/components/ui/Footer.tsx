...
export const Footer = () => {
  return (
    <footer className="bg-[var(--dark-bg)] text-white">
      ...
      <div className="bg-[var(--light-bg)] py-12">
      ...
      {/* Main Footer */}
      <div className="py-10 bg-[var(--dark-bg)]">
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            <div className="md:col-span-4">
              ...
              <p className="text-gray-400 mb-6">
                医療分野におけるAI技術の革新を通じて、より良い医療と健康社会の実現に貢献します。
              </p>
            ...
            <div className="md:col-span-3">
              ...
              <ul className="space-y-2 text-gray-400">
                <li className="flex items-start">
                  ...
                  <span>〒100-0001 東京都千代田区1-1-1 コンポジションビル</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                  </svg>
                  <a href="mailto:info@composition2940.com" className="hover:text-white">
                ...
                <li className="flex items-center">
                  ...
                  <a href="tel:03-1234-5678" className="hover:text-white">
                    03-1234-5678
                  </a>
                </li>
              </ul>
      ...
      <div className="py-4 border-t border-gray-800">
        <div className="container-custom text-center text-gray-500 text-sm">
          &copy; {new Date().getFullYear()} Composition Inc. All rights reserved.
        </div>
      </div>
    </footer>
  );
